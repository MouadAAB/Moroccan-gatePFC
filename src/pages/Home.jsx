...
export default function Home() {
	return (
		<div>
			...
			<div className='h-[100vh] flex p-3  bg-black'>
				<div className='matches  h-[100%] bg-white rounded-2xl shadow-2xl w-[38%]'>
					<div className=' bg-[#FBB117]  rounded-t-2xl text-center font-sans font-bold text-3xl tracking-normal text-white p-3'>
						Matchweek
					</div>
					<div className='p-4 overflow-auto h-full'>
						<div className='flex flex-col gap-4'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-4 rounded-lg shadow-sm'>
								...
								<a
									href='/match-game'
									className='text-[#234F1E] hover:text-[#00A448]'
								>
				...
				<div className=' w-[72%] h-[90%]  px-4 pt-3'>
					<div className='h-[75%] slidBox relative  p-[3px]'>
						<Swiper
							speed={1000}
							loop={true}
							centeredSlides={true}
				...
				>
					...
					<SwiperSlide>
						<div className=' p-6 bg-[#FBB117] rounded-lg shadow-lg'>
							...
							/>
							<p className='mt-2 text-[#3C280D]'>
								RABAT | Moulay Abdallah Complex | Stadium (69.500 seats) &
								Olympic Stadium (21.740 seats)
							</p>
						</div>
					</SwiperSlide>
					<SwiperSlide>
			...
			<h4 className='text-3xl font-bold text-center text-black m-4 mb-6'>
				Les groupes de qualification pour la CAN TotalEnergies CAF Maroc 2025
				dévoilés
			</h4>
			<p className='hidden text-center text-xs text-[#234F1E] m-4 mb-6'>
				Le tirage au sort des éliminatoires de la Coupe d'Afrique des Nations
				TotalEnergies CAF, Maroc 2025, a eu lieu jeudi à Johannesburg. <br />
				48 pays africains tenteront de se qualifier pour la 35e édition de la
				compétition biennale africaine dans le but de détrôner la Côte d'Ivoire
				de l'entraîneur Emerse Fae en tant que roi du continent.
				<br />
				Fae - l'un des deux assistants du tirage au sort avec la légende
				marocaine Marouane Chamakh - a vu son équipe placée dans un groupe
				délicat alors qu'elle tentait de défendre son titre.
				<br />
				La Côte d'Ivoire est championne en titre après avoir battu le Nigeria
				2-1 en finale de la compétition sportive phare du continent à Abidjan
				plus tôt cette année.
				<br />
				Les Éléphants ont été placés dans le groupe G où ils affronteront les
				anciens champions de la Zambie, de la Sierra Leone et du Tchad.
				<br />
				Le Maroc, hôte, a été placé dans le groupe B.
				<br />
				Les Lions de l'Atlas affronteront le Gabon, la République centrafricaine
				et le Lesotho.
				<br />
				Le Maroc abordera cette campagne de qualification avec moins de pression
				puisqu'il est déjà assuré de participer à la compétition à domicile.
				<br />
				Le trophée tant convoité sera remis en jeu avec le début des
				éliminatoires de la prochaine CAN TotalEnergies CAF qui se déroulera
				dans le pays d'Afrique du Nord.
				<br />
				Les qualifications débuteront en septembre 2024 et se termineront en
				novembre 2024.
				<br />
				Le premier et le deuxième des onze (11) groupes qui n'impliquent pas le
				Maroc, hôte du tournoi, obtiendront leur qualification pour la
				compétition.
				<br />
				La Coupe d'Afrique des Nations TotalEnergies CAF est le plus grand
				événement sportif d'Afrique et le prochain championnat se tiendra du 21
				décembre 2025 au 18 janvier 2026.
				<br /> <br />
				<hr />
				<b> Groupes: </b>{" "}
			</p>

			<div className='grid grid-cols-6  m-7 '>
				<div className='matches w-[200px] h-[270px] bg-[#8d0000] rounded-2xl shadow-2xl m-4'>
					<div className=' bg-[#234F1E]  rounded-t-2xl text-center font-sans font-normal text-2xl tracking-normal text-white p-1'>
						Groupe A
					</div>
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Tunisia.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Madagascar-Flag.jpg'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Flag_Comoros.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Gambia.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Central-Africa-Republic.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
									<span className='font-semibold text-lg text-xs'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Lesotho.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Cape-Verde.jpeg'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Mauritania.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Botswana.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Nigeria.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Libya.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Rwanda.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Equatorial-Guinea.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
									<span className='font-semibold text-lg text-xs'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Togo.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Liberia.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Sudan.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Niger.png'
										alt='Egypt Flag'
										className='w-8 h-6'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src="/src/assets/images/Cote-d'Ivoire.png"
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Zambia.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Sierra-Leone.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Guinea.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Tanzania.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Ethiopia.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Mali.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Mozambique.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Eswatini.png'
										alt='Egypt Flag'
										className='w-8 h-6'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Namibia.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Kenya.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Zimbabwe.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Uganda.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Congo.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/South-Sudan.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					<div className='p-3 overflow-auto h-90'>
						<div className='flex flex-col gap-2'>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Burkina-Faso.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Malawi.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
							...
							<div className='flex justify-between items-center bg-[#f0f0f0] p-2 rounded-lg shadow-sm'>
								<div className='flex items-center gap-2'>
									<img
										src='/src/assets/images/Burundi.png'
										alt='Egypt Flag'
										className='w-8 h-5'
									/>
					...
					>
						<SwiperSlide>
							<div className='flex justify-center'>
								<img
									src='/src/assets/images/sponsor10.jpg'
									alt=''
