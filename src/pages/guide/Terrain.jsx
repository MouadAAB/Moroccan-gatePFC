...
const stadiums = [
	...
	},
	{
		...
		capacity: "45,240",
		description:
			"The Stade de Marrakech is a multi-purpose stadium in Marrakech. It is used primarily for football and hosts national and international matches.",
	...
	},
	{
		...
		capacity: "45,480",
		description:
			"The Stade Adrar is a multi-purpose stadium in Agadir. It is used mostly for football matches and hosts various other events.",
	...
	},
	{
		...
		capacity: "45,000",
		description:
			"The Stade Ibn Batouta is a multi-purpose stadium in Tangier. It is primarily used for football matches and has hosted many international events.",
		...
		<div className='min-h-screen bg-[#0F5132]'>
			...
			<div className='container mx-auto px-4 py-10'>
				{stadiums.map((stadium, index) => (
					<div
						key={index}
						className='bg-[#F0FFF0] rounded-lg shadow-lg overflow-hidden mb-10 flex flex-col md:flex-row'
					>
