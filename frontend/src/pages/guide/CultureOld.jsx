...
const CultureOld = () => {
	...
	useEffect(() => {
		const handleScroll = () => {
			...
			sectionsRef.current.forEach((section, index) => {
				const offset = section.offsetTop - 175;
	...
	return (
		<div className='pt-2 '>
			<div className='fixed z-10 w-full h-fit bg-white '>
				<nav className='element-center '>
					{sections.map((section, idx) => (
						<a
							...
							href={`#${section}`}
							className={`${
								activeLink === section ? ` bg-[${colors[idx]}]` : ""
							} relative py-[12px] px-[20px] text-black font-[600]  rounded-t-[10px]`}
			...
			<section
				...
				className='cult w-screen h-fit bg-[#5D190F] pt-16 pb-8 flex flex-col gap-5'
			>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						<div className='text-3xl font-bold mb-4 text-center'>Zellige</div>
						<p className='text-lg leading-normal '>
							...
							d'émaillage et de cuisson pour des pièces uniques. Motifs inspirés
							de la nature et de l'art islamique, étoiles, rosaces, arabesques
							et formes abstraites. Revêtements muraux intérieurs et extérieurs,
							apportant une touche de couleur vibrante et de raffinement.
							Symbole de la culture marocaine, reflétant son identité, son
							patrimoine, sa beauté et sa valeur artisanale.
						</p>
					</div>
				</div>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							...
							Tissage ancestral marocain riche en histoire et en culture. Motifs
							géométriques et symboliques variés, souvent inspirés de la nature
							et de la vie quotidienne. Réalisés à la main avec de la laine de
							mouton naturelle, teintée avec des colorants végétaux. Pièces
							uniques qui reflètent l'identité et le savoir-faire des tribus
							berbères.
						</p>
					</div>
				</div>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							...
							Production variée : sacs, poufs, chaussures, babouches, ceintures,
							bijoux et articles de décoration. Symbole de l'artisanat marocain,
							admiré pour sa qualité, sa beauté et son authenticité.
						</p>
					</div>
				</div>
			...
			<section
				...
				className='w-screen h-fit bg-[#9c6644] pt-16 pb-8 flex flex-col gap-5'
			>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					<div className='w-[30%] element-center'>
						<img
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							...
							aujourd'hui par ses motifs géométriques, ses sculptures en stuc et
							ses zellige colorés. Cour principale aux bassins et fontaine,
							...
							imprenable sur la médina depuis son toit-terrasse. Incontournable
							pour tout visiteur de Marrakech.
						</p>
					</div>
				</div>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							Une forteresse historique à Rabat avec des jardins andalous. Vigie
							fortifiée du XIIe siècle à Rabat, la Kasbah des Oudayas offre un
							havre de paix aux visiteurs. Anciennement fief des pirates et
							palais royal alaouite, elle dévoile un dédale de ruelles bleutées,
							jardins andalous et vue imprenable sur l'océan. Musée des bijoux,
							artisanat local et panoramas somptueux complètent ce joyau
							architectural, classé au patrimoine mondial de l'UNESCO. Une
							immersion inoubliable dans l'histoire et la culture marocaines.
						</p>
					</div>
				</div>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						<div className='text-3xl font-bold mb-4 text-center'>Volubilis</div>

						<p className='text-lg leading-normal '>
							Des ruines romaines bien préservées situées près de Meknès.
							Splendides vestiges romains au Maroc, Volubilis offre un voyage
							dans le temps. Ancienne capitale de la Maurétanie Tingitane, elle
							dévoile ses arcs de triomphe, mosaïques raffinées et maisons
							patriciennes, classés au patrimoine mondial de l'UNESCO.
							Promenez-vous sur le Decumanus Maximus, admirez l'Arc de Caracalla
							et plongez dans l'histoire fascinante de cette cité antique. Une
							immersion inoubliable dans la Rome impériale.
						</p>
					</div>
				</div>
			...
			<section
				...
				id='Festivals'
				className='w-screen h-fit bg-[#ddb892] pt-16 pb-8 flex flex-col gap-5'
			>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					<div className='w-[30%] element-center'>
						<img
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							...
							patrimoine culturel immatériel de l'UNESCO. Festival nomade annuel
							au Maroc, le Moussem de Tan-Tan rassemble tribus sahariennes pour
							célébrer leur culture. Cavalcades, spectacles de musique et de
							danse, artisanat traditionnel rythment cet événement unique,
							inscrit au patrimoine immatériel de l'UNESCO. Une immersion
							vibrante dans les traditions nomades du Sahara.
						</p>
					</div>
				</div>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							...
							Gnaouas et artistes du monde entier célèbrent la culture Gnaoua et
							créent des fusions musicales uniques. Un rendez-vous
			...
			<section
				...
				className='w-screen h-fit bg-[#CCCCCC] pt-16 pb-8 flex flex-col gap-5'
			>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					<div className='w-[30%] element-center'>
						<img
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							Auteur de romans et nouvelles sur la vie au Maroc. Ahmed Sefrioui
							(1915-2004) : Écrivain marocain pionnier de la littérature
							francophone, Ahmed Sefrioui est célèbre pour son roman
							autobiographique "La Boîte à Merveilles", ode à son enfance dans
							la médina de Fès. Figure emblématique de la littérature
							maghrébine, il explore dans ses œuvres les thèmes de l'enfance, de
							la tradition et de l'identité culturelle. Son style poétique,
							empreint de spiritualité, restitue la magie et la beauté de la vie
							marocaine. Conservateur du musée Batha à Fès, Sefrioui a également
							contribué à la préservation du patrimoine culturel marocain. Son
							œuvre, traduite en plusieurs langues, continue d'inspirer les
							générations futures.
						</p>
					</div>
				</div>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							...
							féminine au Maroc. Fatima Mernissi (1940-2015) : Féroce féministe
							et écrivaine marocaine, Mernissi a bousculé les stéréotypes de
							genre et les interprétations patriarcales de l'Islam. Ses écrits
							explorent la sexualité, le mysticisme et la place des femmes dans
							la société musulmane. Figure du féminisme islamique, elle a plaidé
							pour l'égalité et l'émancipation des femmes musulmanes. Son
							héritage inspire encore aujourd'hui.
						</p>
					</div>
				</div>
				...
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							...
							explorant identité, immigration, amour et sexualité. Défenseur des
							droits humains et de la liberté d'expression. Style fluide et
							accessible, mêlant autobiographie et fiction. Figure majeure de la
			...
			<section
				...
				className='w-screen h-fit bg-[#E0CDA9] pt-16 pb-8 flex flex-col gap-5'
			>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					<div className='w-[30%] element-center'>
						<img
					...
					<div className='w-[70%]'>
						<div className='text-3xl font-bold mb-4 text-center'>Djellaba</div>
						<p className='text-lg leading-normal '>
				...
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						<div className='text-3xl font-bold mb-4 text-center'>Caftan</div>
						<p className='text-lg leading-normal '>
				...
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						<div className='text-3xl font-bold mb-4 text-center'>Babouches</div>
						<p className='text-lg leading-normal '>
							...
							marocaine. Appréciées pour leur confort et leur style intemporel,
							elles se portent aussi bien à la maison qu'à l'extérieur. Leur
							fabrication artisanale et leurs déclinaisons variées en font un
							accessoire de mode unique et authentique.
						</p>
					</div>
				</div>
			...
			<section
				...
				className='w-screen h-fit bg-[#370028] pt-16 pb-8 flex flex-col gap-5'
			>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					<div className='w-[30%] element-center'>
						<img
					...
					<div className='w-[70%]'>
						<div className='text-3xl font-bold mb-4 text-center'>Fantasia</div>
						<p className='text-lg leading-normal '>
							Une démonstration équestre spectaculaire où des cavaliers habillés
							en costumes traditionnels tirent en l'air avec des fusils.
							Spectacle équestre traditionnel du Maroc, la Fantasia est une
							représentation de charges de cavalerie simulées, accompagnées de
							tirs de fusil à poudre et de musique. Symbole de la bravoure et de
							l'habileté des cavaliers, elle se déroule généralement lors de
							fêtes et célébrations. La Fantasia est une tradition vivante qui
							attire chaque année de nombreux visiteurs, admirant la beauté des
							chevaux, la précision des cavaliers et la richesse du folklore
							marocain.
						</p>
					</div>
				</div>
				...
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
					...
					<div className='w-[70%]'>
						...
						<p className='text-lg leading-normal '>
							...
							générations, il se joue avec 16 pions chacun, selon des règles et
							un vocabulaire uniques.
						</p>
					</div>
				</div>
				<div className='w-[85%] h-[35%] element-center gap-4 bg-[#E5AD76] mx-auto rounded-2xl text-black py-2 px-2'>
